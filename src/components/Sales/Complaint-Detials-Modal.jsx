          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-4">
              <Avatar className="w-16 h-16">
                <AvatarImage src={`https://api.dicebear.com/6.x/initials/svg?seed=${complaint.customerName}`} />
                <AvatarFallback>
              ...
              <div>
                <h3 className="text-lg font-semibold">{complaint.customerName}</h3>
            ...
            <div>
              ...
              <Badge
                variant="secondary"
                className={`${getStatusColor(complaint.status)} flex items-center space-x-1 text-xs px-2 py-1`}
              >
